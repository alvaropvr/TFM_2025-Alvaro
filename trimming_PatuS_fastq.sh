...
for r1 in "$input_dir"/*_R1_*.fastq.gz; do
    ...
    # Ejecutar cutadapt para recortar 50 pb de los extremos iniciales (5') de las secuencias paired-end
    cutadapt \
        -u -50 \  # Recortar 50 pb del extremo 5' para lecturas forward
        -U -50 \  # Recortar 50 pb del extremo 5' para lecturas reverse
